...
::: info Using multiple notifications with environment variables
...
-   Watchtower will post a notification every time it is started. This behavior [can be changed](/arguments#without-sending-a-startup-message) with an argument.
